...
const char OTA_HOST[] = "your-server.com";
const uint16_t OTA_PORT = 80;
const char OTA_VERSION_PATH[] = "/CellularOTA/version.txt";
const char OTA_BINARY_PATH[] = "/CellularOTA/CellularOTA.bin";
const uint32_t OTA_CONNECT_TIMEOUT_MS = 30000UL;
const uint32_t OTA_READ_TIMEOUT_MS = 120000UL;
const uint8_t OTA_MIN_BATTERY_PERCENT = 40;
const int OTA_MIN_RSSI = -95;
